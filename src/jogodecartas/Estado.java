...
public final class Estado {
    ...
    public static final Estado JOGA = new Estado("AGUARDANDO JOGADA");
    //public static final Estado AGUARDANDO_PUXA = new Estado("AGUARDANDO PUXA");
    public static final Estado PASSA = new Estado("AGUARDANDO PASSAR");
    public static final Estado MUDA_COR = new Estado("AGUARDANDO MUDA COR");
